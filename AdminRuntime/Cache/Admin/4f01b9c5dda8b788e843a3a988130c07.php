      ...
      <div class="tab-pane active" id="fa-icons">
       <section id="new">
        <div class="row fontawesome-icon-list">
         <form id="formOne" role="form" method="post" action="<?php echo U('Tasks/addtask');?>" enctype="multipart/form-data">
          <div class="box-body" style="margin-left:15px;">
              <div class="form-group">
                  <label>任务名称</label>
                  <select class="form-control" selected=true name="navid" onchange="setConfig(this)">
                      <?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?><option value="<?php echo ($nav["nav_id"]); ?>"><?php echo ($nav["nav_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                  </select>
              </div>
           ...
           <!-- /.form group -->
              ...
              <div class="form-group" id="main" style="border:1px dotted red;padding:3px;display:none">
				...
				function setformurl(){
					//alert("上传成功");
					document.getElementById("formOne").action = "<?php echo U('Tasks/Upload');?>";
					return true;
				}
				</script>
              ...
              <!--<div class="form-group">-->
                  <!--<label>下单量</label>-->
                  <!--<div class="radio">-->
                      <!--<input type="text" name="tasksnumber">-->
                  <!--</div>-->
              <!--</div>-->
              <!--<div class="form-group">-->
                  ...
                  <!--<div class="radio">-->
                      <!--<label>-->
                          <!--<input type="radio" name="taskstutas" class="iradio_flat-green" value="0" checked >开启-->
                      <!--</label>-->
                      <!--<label>-->
                          <!--<input type="radio" name="taskstutas" class="flat-red" value="1" checked>关闭-->
                      <!--</label>-->
                  <!--</div>-->
              <!--</div>-->
              <input type="hidden" name="taskstutas" value="1">
          </div>
          <!-- /.box-body -->
         </div>
...
//    alert(id);
     $.ajax({
         url:"<?php echo U('Tasks/getConfigs');?>",
         type:"post",
         dataType: "json",
         data:{'configId':id  },
         async: "false",
 ...
 var navId = '<?php echo ($firstNavId); ?>';
 //alert(navId);
 
 if(navId != ''){
	 setFirstConfig('<?php echo ($firstNavId); ?>');
 }
