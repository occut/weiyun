      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="layui-form" role="form" method="post" action="<?php echo U('Vpnaddress/saveEdit');?>" enctype="multipart/form-data">
              <div class="box-body">
                 ...
                 <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                        <input type="hidden" name="address_id" value="<?php echo ($data["account_id"]); ?>">
                        <input type="text" name="address_url" required  lay-verify="required"  value="<?php echo ($data["address_url"]); ?>" autocomplete="off" class="layui-input">
                    </div>
                </div>
