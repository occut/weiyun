                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr class="tng">
                                    ...
                                    <th style = "text-align: center;">预计收货时间</th>
                            ...
                            <?php if(is_array($usergroups)): $i = 0; $__LIST__ = $usergroups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tnd" style = "text-align: center;">
                                    ...
                                    <!-- <td >
                                        <?php
 $a = (strtotime($vo['delivery_time']) - time()); $day = floor($a/(24*3600)); if($day == 0){ $h = floor($a/3600); }else{ $h = floor($a/3600); $h = $h - 24*$day; } $d = $a % 3600; $s = floor($d/60); $day = $day+1; if($day>=0){ if($day>=3){ echo "<p style=''>".$day."天" .$h."小时</p>"; }else{ echo "<p style='color:red;'>".$day."天" .$h."小时</p>"; } }else{ echo "<p style='color:red;'>已过期</p>"; } ?>
                                    </td> -->
