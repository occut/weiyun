...
//        echo 1;
       // var_dump($aa);
//        $b['fatherID'] = $aa['cityid'];
//        $bb = $cityMode->where($b)->select();
//        var_dump($bb);
    }
    /**
     * 更改IP
...
//        var_dump($res);
    ...
    public function edittimeTasks(){
        if(IS_GET) {
            ...
            $city1=$ctModel->select();
            $wei_province = I('wei_province');//接收传过来的值：省
            $wei_city = I('wei_city');//接收传过来的值：市
