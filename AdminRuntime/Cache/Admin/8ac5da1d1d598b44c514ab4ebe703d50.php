...
<div class="layui-body">
    ...
    <section class="content">
        <div class="row">
            ...
            <!-- /.box-header -->
            <!-- form start -->
                    <form action="<?php echo U('Admin/addRoleResource');?>" method="post" >
                        <input type="hidden" value="<?php echo ($role["role_id"]); ?>" name="roleid">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo ($role["role_name"]); ?></label>

                            </div>
                            <!-- checkbox -->

                            <div class="form-group">
                                <?php if(is_array($showmodules)): $i = 0; $__LIST__ = $showmodules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="look">
                                        <input type="checkbox" class="flat-red" name="moduleid[]" value="<?php echo ($vo["module_id"]); ?>"
                                               <?php if(is_array($rolemodule)): $i = 0; $__LIST__ = $rolemodule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i; if(($vo["module_id"]) == $voo["module_id"]): ?>checked<?php endif; endforeach; endif; else: echo "" ;endif; ?> 
                                               >
