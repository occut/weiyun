            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href="#"><button type="button" class="btn btn-block btn-primary">模块列表</button></a></h3>
            ...
            <!-- /.box-header -->
                    ...
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($modules)): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tnd">
                                    <td><?php echo ($vo["module_id"]); ?></td>
                                    <td><?php echo ($vo["module_name"]); ?></td>  
                                    <td><?php echo ($vo["module_url"]); ?></td>  
                                    <td>
                                        <a href="<?php echo U('Admin/editModule',array('moduleid'=>$vo['module_id'],'gd'=>$groupId,'md'=>$menuId));?>">编辑</a>
                                        <a href="javascript:if(confirm('确实要删除吗?'))location='<?php echo U('Admin/deleteModule',array('moduleid'=>$vo['module_id'],'gd'=>$groupId,'md'=>$menuId));?>'">删除</a>
