      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo U('Shop/ShopStore');?>" enctype="multipart/form-data">
              <div class="box-body">
               ...
               <!--  <div class="form-group">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                      <!--   <input class="layui-input" name="delivery_time" value="<?php echo ($tasks["time_starttime"]); ?>"  placeholder="预计收货时间" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"> -->
