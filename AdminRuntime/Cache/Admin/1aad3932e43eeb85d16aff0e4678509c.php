        ...
        <section class="content">
            ...
            <form class="layui-form" method="post" action="<?php echo U('Tasks/edittimeTasks');?>">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:400px;margin-left:0px;">
                        <input type="text" name="ip" value="<?php echo ($tasks["time_ip"]); ?>" required  lay-verify="required" placeholder="点此搜索经纬度" autocomplete="off" class="layui-input" onclick="add('腾讯地图','<?php echo U('Tasks/getlocation');?>')">
                    </div>
                </div>
                <div class="layui-form-item">
