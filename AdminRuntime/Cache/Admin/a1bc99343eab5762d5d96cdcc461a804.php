            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                       ...
                       <select style="width: 200px;height: 40px;border: 1px solid #E6E6E6">
                        <option value="">-----请选择-----</option>
                        <?php if(is_array($allShops)): $i = 0; $__LIST__ = $allShops;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shop): $mod = ($i % 2 );++$i;?><option value="<?php echo ($shop["id"]); ?>"><?php echo ($shop["shop_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                       </select>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($usergroups)): $i = 0; $__LIST__ = $usergroups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tnd" style = "text-align: center;">
                                    ...
                                    <td><?php echo ($vo["order_details"]); ?></td>
                                    <!-- <td>
                                        <a href="<?php echo U('Shop/editshop',array('id'=>$vo['id']));?>">编辑</a>
