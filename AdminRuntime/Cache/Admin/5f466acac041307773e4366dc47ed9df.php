      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo U('VpnAccount/vpnAccountStore');?>" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                        <select class="layui-input" name="equipment">
                        <?php if(is_array($allEquipment)): $i = 0; $__LIST__ = $allEquipment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$allE): $mod = ($i % 2 );++$i;?><option><?php echo ($allE["group_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   ...
                   <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                        <input type="text" name="account_name" required  lay-verify="required" placeholder="请输入账号" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width:150px;">密码</label>
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                        <input type="text" name="account_password" required  lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
                    </div>
                </div>
                </div>
              <!-- /.box-body -->
