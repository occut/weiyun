      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo U('Shop/editorder');?>" enctype="multipart/form-data">
              <div class="box-body">
               <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                        <input type="text" name="wei_number" required  lay-verify="required" placeholder="请输入手机号" value="<?php echo ($data["wei_number"]); ?>" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <!--  <div class="layui-form-item">
                ...
                <!--  <div class="layui-form-item">
                    <label class="layui-form-label" style="width:150px;">支付密码</label>
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                        <input type="text" name="order_number" required  lay-verify="required" placeholder="请输入店铺名称" value="<?php echo ($data["order_number"]); ?>" autocomplete="off" class="layui-input">
                    </div>
                </div> -->
                ...
                <!--  <div class="layui-form-item">
                    <label class="layui-form-label" style="width:150px;">IP</label>
                    <div class="layui-input-inline" style="width:200px;margin-left:0px;">
                        <input type="text" name="order_number" required  lay-verify="required" placeholder="请输入店铺名称" value="<?php echo ($data["order_number"]); ?>" autocomplete="off" class="layui-input">
                    </div>
                </div> -->
