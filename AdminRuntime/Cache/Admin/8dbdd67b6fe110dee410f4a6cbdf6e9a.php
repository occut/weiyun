        ...
        <div class="layui-field-box">
            <div id="dataContent" class="">
                ...
                <table class="layui-table" id="tabletree">
                    <thead>
                    <tr class="tng">
                        <th style="width:10%;text-align: center;">设备列表</th>
                        <th style="width:20%;text-align: center;">分组名称</th>
                        <th style="width:30%;text-align: center;">任务名称</th>
                        <th style="width:40%;text-align: center;">任务进度</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php if(is_array($tasksGroup)): $i = 0; $__LIST__ = $tasksGroup;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-tb-pid="<?php echo ($v["parentId"]); ?>" data-tb-id="<?php echo ($v["catId"]); ?>">
                            <td style="text-align: center;"><span><?php echo ($vo["equlist"]); ?></span></td>
                            <td style="text-align: center;" class="treename"><span><?php echo ($vo["group_name"]); ?></span></td>
                            <td style="text-align: center;"><span><?php echo ($vo["tasks_name"]); ?></span></td>
                            <td style="text-align: center;"><span><?php echo ($vo["tasks_state"]); ?></span></td>
