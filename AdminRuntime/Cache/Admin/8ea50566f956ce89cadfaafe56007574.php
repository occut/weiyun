        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                   ...
                   <h3 class="box-title"><a href="#"><button type="button" class="btn btn-block btn-primary">编辑模块</button></a></h3>
                 
                    </div>
                    <!-- /.box-header -->
            <!-- /.box-header -->
            <!-- form start -->
                    <form action="<?php echo U('Admin/editModule');?>" method="post" >
                        <input type="hidden" name="moduleid" value="<?php echo ($listmodule["module_id"]); ?>" >
                        <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">模块名</label>
                                <input type="text" class="form-control" name="modulename" value="<?php echo ($listmodule["module_name"]); ?>" autofocus id="exampleInputEmail1" placeholder="请输入模块名" required>
                            </div>

                            <div class="form-group" for="tn">
                                <label for="tn">模块URL</label>
                                <input type="text" class="form-control" name="moduleurl" value="<?php echo ($listmodule["module_url"]); ?>" id="tn" placeholder="请输入模块URL" required>
                            </div>
