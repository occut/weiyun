                    ...
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($allAccounts)): $i = 0; $__LIST__ = $allAccounts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="tnd" style = "text-align: center;">
                                    ...
                                    <td>
                                        <a href="<?php echo U('Vpn/editVpnAccount',array('account_id'=>$vo['account_id']));?>">编辑</a>
                                        <a href="javascript:if(confirm('确实要删除吗?'))location='<?php echo U('Vpn/deleteVpnAccount',array('account_id'=>$vo['account_id']));?>'">删除</a>
                                    </td>
